            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="city" class="col-md-4 col-form-label text-md-end">{{ __('Grad') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="post_code" class="col-md-4 col-form-label text-md-end">{{ __('Postanski broj') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="country" class="col-md-4 col-form-label text-md-end">{{ __('Drzava') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="mobile_phone" class="col-md-4 col-form-label text-md-end">{{ __('Mobilni telefon') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('Potvrdite sifru') }}</label>
